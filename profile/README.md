...
The skills can be installed by git cloning the repos into ~/mycroft-core/skills or by first installing the [Cloner](https://github.com/Tux-Display/Cloner) skill and running the skill.
